...
<div class="form-control-lg">
  <input type="text" minlength ="17" name="cnpj" data-mask="00.000.000/000-00" placeholder="00.000.000/000-00" value="{{isset($clientes->cnpj) ? $clientes->cnpj : '' }}">
  <label>CNPJ</label>
</div>

<div class="form-control-lg">
  <input type="text" name="razao_social" value="{{isset($clientes->razao_social) ? $clientes->razao_social : '' }}">
