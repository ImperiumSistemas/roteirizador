        ...
        <ul style="background-color:orange" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li style="background-color: orange" class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a href="{{route('listagem.pessoas')}}" class="collapse-item" >PESSOA</a>
                        <a href="{{route('listagemCliente')}}" class="collapse-item" >CLIENTES</a>
                        <a href="{{route('listagem.confirmaEndereco')}}" class="collapse-item" >CONFIRMAR ENDEREÇO</a>
                        <a href="{{route('listagem.motorista')}}" class="collapse-item" >MOTORISTA</a>
                    </div>
                </div>
            </li>
            ...
            <li style="background-color: orange" class="nav-item">
                <a  style="background-color: orange" class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <i style="background-color: orange" class="fas fa-fw fa-wrench"></i>
                    <span>Utilities</span>
                </a>
                <div style="background-color: orange" id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                     data-parent="#accordionSidebar">
                    <div style="background-color: orange" class="bg-white py-2 collapse-inner rounded">
                        <h6 style="background-color: orange" class="collapse-header">Custom Utilities:</h6>
                        <a style="background-color: orange" class="collapse-item" href="utilities-color.html">Colors</a>
                        <a style="background-color: orange" class="collapse-item" href="utilities-border.html">Borders</a>
                        <a style="background-color: orange" class="collapse-item" href="utilities-animation.html">Animations</a>
                        <a style="background-color: orange" class="collapse-item" href="utilities-other.html">Other</a>
                    </div>
                </div>
            </li>
